 ...
 * to (used for the folder segment and the sanitized file name) and what extension the file
 * should carry.
 *
 * [extension] is **not** [CloudDownloadQuality.extension]: that field describes a requested
 * transcoding target and is `null` for [CloudDownloadQuality.MAX] (the literal copy — there
